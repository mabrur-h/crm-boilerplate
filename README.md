...
| Demo ko‘rish | [crm-boilerplate.mabrur-h11.workers.dev](https://crm-boilerplate.mabrur-h11.workers.dev) <!-- DEMO_URL --> | Kirish: `demo@example.com` / `demo12345`. Bu demo’da ro‘yxatdan o‘tish yopilgan |
