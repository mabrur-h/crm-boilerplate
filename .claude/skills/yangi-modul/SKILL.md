...
4. **Constants** — `src/features/products/constants.ts`: agar bosqich/holat kabi qiymatlar bo‘lsa, `CLIENT_STAGES`ga o‘xshab o‘zbekcha label’lar bilan massiv qiling.
