// Error boundary for every route under `(auth)` (`/login`, `/signup`) —
// mirrors `src/app/(app)/error.tsx`. Must be a client component — Next
// passes it a `reset()` callback to retry the failed render.
"use client";
